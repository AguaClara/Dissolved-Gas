# Python code for the minimum fluidization flow rate of the prototype fluidized
# bed reactor.

# This code assumes the user knows the porosity of the sand used in the
# fluidized bed.
...
# The following code, determining the bed's minimum flow for fluidization,
# adheres to the equation in Source 4 in the Fluidization page of the
# Literature folder (i.e. Fluidization Source 4). The code requests the
# reactor's cross sectional area in order to calculate the fluidization flow
# rate at the end of the script.
...
porosity = float(input("What is the porosity of the sand bed?\n"))
    ...
    density_sand = float(input("What is the density of the sand, in units of" +
    "kilograms per cubic meter?\n"))*u.kg/(u.m**3)

    density_water = 997*u.kg/(u.m**3)

    diameter = float(input("What is the average diameter of the sand grains," +
    ...
    viscosity = float(input("What is the kinematic viscosity of water, in" +
    "units of millimeters squared per second?\n"))*u.mm**2/u.s
